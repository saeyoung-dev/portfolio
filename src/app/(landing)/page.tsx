...
export default function Home() {
  ...
  return (
    <main className="flex w-full flex-col items-center">
      <section className="sm:min-h-screen w-full container flex flex-col items-center justify-center px-6 pt-20 pb-10 sm:px-8 md:px-16 lg:px-32 sm:pt-24 md:pt-32 text-green-900 2xl:gap-10 2xl:flex-col 2xl:justify-evenly">
        <div className="sm:py-0 py-24 2xl:h-full 2xl:flex-1 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:px-32 w-full">
          <div className="flex flex-col gap-6 items-center justify-center lg:items-start lg:gap-8 2xl:px-12">
            <h1
              ref={titleRef}
              className="text-4xl sm:text-5xl md:text-6xl lg:text-[6.25rem] 2xl:text-[7.5rem] 2xl:mb-4 font-title break-keep"
            >
              Saeyoung Choi.
            </h1>
            <div
