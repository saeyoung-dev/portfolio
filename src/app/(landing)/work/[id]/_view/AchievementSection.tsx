        ...
        {achievements.highlights &&
          achievements.highlights.map((highlight, index) => (
            <div
              ...
              className='flex justify-center items-center gap-2 sm:gap-4 w-full bg-white rounded-2xl p-4 sm:p-6 shadow'
            >
              <span className='size-6'>
                <CircleCheck fill='#14532d' strokeWidth={2} stroke='white' />
              </span>
              <p className='text-base sm:text-lg font-semibold text-green-900 leading-auto sm:leading-8 break-keep'>
                {highlight[language]}
              </p>
            </div>
          ))}
