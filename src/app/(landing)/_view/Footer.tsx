...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="w-full text-green-900 justify-center flex opacity-0 px-8 sm:px-10"
    >
      <div className="border-t-2 border-green-900 sm:border-none flex-col px-0 items-center gap-10 sm:gap-0 sm:flex-row flex sm:justify-between sm:items-end container w-full max-w-[1400px] py-16">
